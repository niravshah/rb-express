var vCalculator =
    new Vue({
        ...
        computed: {
            rb_pf: function () {
                return this.amountRaised * 0.02
            },
            rb_cpf: function () {
                return this.amountRaised * 0.014 + 0.20
            },
            rb_total: function () {
                return this.amountRaised - (this.rb_pf + this.rb_cpf)
            },
            jg_pf: function () {
                return this.amountRaised * 0.05
            },
            jg_cpf: function () {
                return this.amountRaised * 0.0125
            },
            jg_total: function () {
            ...
            gfm_cpf: function () {
                return this.amountRaised * 0.035 + 0.20
            },
            gfm_total: function () {
